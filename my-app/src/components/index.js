...
export { default as ResumeComponent } from './feature/resume';
export { default as NavbarComponent } from './layout/Navbar';
export { default as SideBarComponent } from './layout/Sidebar';
